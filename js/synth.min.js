...
var container, camera, scene, renderer, video, texture, material, mesh, composer, renderModel, effectBloom, effectHue, effectCopy, mouseX = 0, mouseY = 0, windowHalfX = window.innerWidth / 2, windowHalfY = window.innerHeight / 2, videoInput = document.getElementById("video"), canvasInput = document.getElementById("compare"), initComplete = !1, hex;
...
f5.add(ruttEtraParams, "scale", .1, 10).step(1).listen().name("Scale");

f5.add(ruttEtraParams, "dimX", 1, 720).step(1).listen().name("X Dimension");

f5.add(ruttEtraParams, "dimY", 1, 720).step(1).listen().name("Y Dimension");

f5.add(ruttEtraParams, "dimZ", 1, 720).step(1).listen().name("Z Dimension");

f5.add(ruttEtraParams, "segX", 1, 720).step(1).listen().name("X Segments");

f5.add(ruttEtraParams, "segY", 1, 720).step(1).listen().name("Y Segments");

f5.add(ruttEtraParams, "segZ", 1, 720).step(1).listen().name("Z Segments");
