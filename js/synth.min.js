...
function listResults(entries) {
    ...
    entries.forEach(function(entry, i) {
        ...
        var li = document.createElement("li"), name = unescape(entry.name), correctName = name.replace("%20", " ");
        li.innerHTML = [ '<a class="track" href="#" data-href="', entry.toURL(), '" data-title="', name, '">', name, "</a>" ].join("");
            ...
            fs.root.getFile(f.name, {
                ...
                fileEntry.file(function(file) {
                    ...
                    reader.onloadend = function(e) {
                        ...
                        var li = document.createElement("li"), name = unescape(fileEntry.name), correctName = name.replace("%20", " ");
                        li.innerHTML = [ '<a class="track" href="#" data-href="', fileEntry.toURL(), '" data-title="', name, '">', name, "</a>" ].join("");
                        document.getElementById("playlist").insertBefore(li, null);
                        var nodeList = Array.prototype.slice.call(document.getElementById("playlist").children), index = nodeList.indexOf(li);
                        li.onclick = function() {
                            playAudio(index);
