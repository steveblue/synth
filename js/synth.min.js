...
$.getJSON("default.json", function(response) {
    ...
    f3.add(synthParams, "cameraz", -3600, 3600).step(.1).listen().name("Zoom").onChange(onParamsChange);
    f3.add(synthParams, "camerax", -3600, 3600).step(.1).listen().name("Camera X").onChange(onParamsChange);
    f3.add(synthParams, "cameray", -3600, 3600).step(.1).listen().name("Camera Y").onChange(onParamsChange);
    f3.open();
