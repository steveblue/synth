...
function newMesh(geo, scale) {
    ...
    scene.remove(mesh);
    geo === "plane" ? geometry = new THREE.PlaneGeometry(videoInput.videoWidth / 2, videoInput.videoHeight / 2, videoInput.videoWidth / 2, videoInput.videoHeight / 2) : geo === "sphere" ? geometry = new THREE.SphereGeometry(videoInput.videoHeight / 2, videoInput.videoHeight / 2, videoInput.videoHeight / 2) : geo === "cube" ? geometry = new THREE.CubeGeometry(videoInput.videoHeight / 3, videoInput.videoHeight / 3, videoInput.videoHeight / 3, videoInput.videoHeight / 3, videoInput.videoHeight / 3, videoInput.videoHeight / 3) : geo === "cylinder" ? geometry = new THREE.CylinderGeometry(scale, scale, videoInput.videoHeight / 2, videoInput.videoWidth / 2, videoInput.videoHeight / 2, !0) : geo === "torus" && (geometry = new THREE.TorusGeometry(scale, videoInput.videoHeight / 2, videoInput.videoHeight / 2, videoInput.videoHeight / 2));
