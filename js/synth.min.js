/*synth v185*/var Synth = function(control, cam) {
    var that = this;
...
Synth.prototype = {
    ...
    defaultVideo: function(url) {
        ...
        var li = document.createElement("li"), name = "default-video.mp4", correctName = "default-video.mp4";
    ...
    paramsChange: function() {
        ...
        that.saturation >= 0 && that.saturation < 1 ? that.effectHue.uniforms.saturation.value = that.saturation : that.saturation < 0 ? that.effectHue.uniforms.saturation.value = 0 : that.saturation > 1 && (that.effectHue.uniforms.saturation.value = 1);
        $("#canvas").css("background-color", that.hex);
        var newhex = parseInt(that.hex.replace("#", "0x"));
        ...
        if (that.audioisplaying === !0) {
            ...
            $(".control.controlled").each(function() {
                ...
                var value = that.convertToRange(control.top, [ 0, $(this).parent(".wrapper").parent(".fader").height() - $(this).height() ], [ $(this).data("start"), $(this).data("end") ]), key = $(this).data("key");
                eval("that." + key + "=" + value + "");
            });
        }
