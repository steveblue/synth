...
hasGetUserMedia ? $("header h2").text('Click "allow" at top of screen to start video.') : $("header h2").text("Synth requires WebRTC & HTML5 Filesystem. Try it out with Google Chrome.");

Detector.webgl || Detector.addGetWebGLMessage();

var container, camera, scene, renderer, video, texture, material, mesh, composer, renderModel, effectBloom, effectHue, effectCopy, mouseX = 0, mouseY = 0, windowHalfX = window.innerWidth / 2, windowHalfY = window.innerHeight / 2, videoPlayer = document.getElementById("videoplayer"), videoInput = document.getElementById("video"), canvasInput = document.getElementById("compare"), videoObject, initComplete = !1, count = 0, hex, webcamEnabled = !1;
...
var videoisplaying = !1, dancer = new Dancer, pointer = [];
...
effectBloom = new THREE.BloomPass(2, 50, 18, 256);
