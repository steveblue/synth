...
f3.add(ruttEtraParams, "cameraz", -8e3, 8e3).step(1).listen().name("Zoom").onChange(onParamsChange);

f3.add(ruttEtraParams, "camerax", -2160, 2160).step(1).listen().name("Camera X").onChange(onParamsChange);

f3.add(ruttEtraParams, "cameray", -2160, 2160).step(1).listen().name("Camera Y").onChange(onParamsChange);
