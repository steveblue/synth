...
dat.utils.common = function() {
    var ARR_EACH = Array.prototype.forEach, ARR_SLICE = Array.prototype.slice;
    return {
        BREAK: {},
        ...
        each: function(obj, itr, scope) {
            if (ARR_EACH && obj.forEach === ARR_EACH) obj.forEach(itr, scope); else if (obj.length === obj.length + 0) {
                for (var key = 0, l = obj.length; key < l; key++) if (key in obj && itr.call(scope, obj[key], key) === this.BREAK) return;
            } else for (var key in obj) if (itr.call(scope, obj[key], key) === this.BREAK) return;
        },
        defer: function(fnc) {
            setTimeout(fnc, 0);
        },
...
dat.controllers.Controller = function(common) {
    ...
    common.extend(Controller.prototype, {
        ...
        setValue: function(newValue) {
            ...
            this.__onChange && this.__onChange.call(this, newValue);
            this.updateDisplay();
            return this;
        },
        getValue: function() {
...
dat.dom.dom = function(common) {
    ...
    var CSS_VALUE_PIXELS = /(\d+(\.\d+)?)px/, dom = {
        ...
        makeFullscreen: function(elem, horizontal, vertical) {
            common.isUndefined(horizontal) && (horizontal = !0);
            common.isUndefined(vertical) && (vertical = !0);
        ...
        fakeEvent: function(elem, eventType, params, aux) {
            ...
            switch (className) {
              case "MouseEvents":
                var clientX = params.x || params.clientX || 0, clientY = params.y || params.clientY || 0;
        ...
        bind: function(elem, event, func, bool) {
            bool = bool || !1;
            elem.addEventListener ? elem.addEventListener(event, func, bool) : elem.attachEvent && elem.attachEvent("on" + event, func);
            return dom;
        },
        unbind: function(elem, event, func, bool) {
            bool = bool || !1;
            elem.removeEventListener ? elem.removeEventListener(event, func, bool) : elem.detachEvent && elem.detachEvent("on" + event, func);
            return dom;
        },
        addClass: function(elem, className) {
            if (elem.className === undefined) elem.className = className; else if (elem.className !== className) {
        ...
        removeClass: function(elem, className) {
            if (className) {
                if (elem.className !== undefined) if (elem.className === className) elem.removeAttribute("class"); else {
                    var classes = elem.className.split(/ +/), index = classes.indexOf(className);
                    if (index != -1) {
...
dat.controllers.NumberController = function(Controller, common) {
    ...
    var NumberController = function(object, property, params) {
        ...
        common.isUndefined(this.__step) ? this.initialValue == 0 ? this.__impliedStep = 1 : this.__impliedStep = Math.pow(10, Math.floor(Math.log(this.initialValue) / Math.LN10)) / 10 : this.__impliedStep = this.__step;
        this.__precision = numDecimals(this.__impliedStep);
    };
    NumberController.superclass = Controller;
    common.extend(NumberController.prototype, Controller.prototype, {
        setValue: function(v) {
            this.__min !== undefined && v < this.__min ? v = this.__min : this.__max !== undefined && v > this.__max && (v = this.__max);
            this.__step !== undefined && v % this.__step != 0 && (v = Math.round(v / this.__step) * this.__step);
...
dat.controllers.NumberControllerBox = function(NumberController, dom, common) {
    ...
    var NumberControllerBox = function(object, property, params) {
        ...
        dom.bind(this.__input, "keydown", function(e) {
            if (e.keyCode === 13) {
                _this.__truncationSuspended = !0;
                this.blur();
                _this.__truncationSuspended = !1;
            }
        });
        this.updateDisplay();
...
dat.controllers.NumberControllerSlider = function(NumberController, dom, css, common, styleSheet) {
    ...
    var NumberControllerSlider = function(object, property, min, max, step) {
        ...
        function onMouseDrag(e) {
            e.preventDefault();
            var offset = dom.getOffset(_this.__background), width = dom.getWidth(_this.__background);
...
dat.controllers.BooleanController = function(Controller, dom, common) {
    var BooleanController = function(object, property) {
        ...
        dom.bind(this.__checkbox, "change", onChange, !1);
    ...
    common.extend(BooleanController.prototype, Controller.prototype, {
        ...
        updateDisplay: function() {
            ...
            } else this.__checkbox.checked = !1;
...
dat.GUI = dat.gui.GUI = function(css, saveDialogueContents, styleSheet, controllerFactory, Controller, BooleanController, FunctionController, NumberControllerBox, NumberControllerSlider, OptionController, ColorController, requestAnimationFrame, CenteredDiv, dom, common) {
    function add(gui, object, property, params) {
        ...
        var controller;
        if (params.color) controller = new ColorController(object, property); else {
            var factoryArgs = [ object, property ].concat(params.factoryArgs);
            controller = controllerFactory.apply(gui, factoryArgs);
        }
        params.before instanceof Controller && (params.before = params.before.__li);
    ...
    function addRow(gui, dom, liBefore) {
        ...
        dom && li.appendChild(dom);
        liBefore ? gui.__ul.insertBefore(li, params.before) : gui.__ul.appendChild(li);
        gui.onResize();
        return li;
    }
    function augmentController(gui, li, controller) {
        ...
        if (controller instanceof NumberControllerSlider) {
            ...
            common.each([ "updateDisplay", "onChange", "onFinishChange" ], function(method) {
                var pc = controller[method], pb = box[method];
        ...
        controller.setValue = common.compose(function(r) {
            gui.getRoot().__preset_select && controller.isModified() && markPresetModified(gui.getRoot(), !0);
            return r;
        }, controller.setValue);
    }
    function recallSavedValue(gui, controller) {
        var root = gui.getRoot(), matched_index = root.__rememberedObjects.indexOf(controller.object);
        if (matched_index != -1) {
            ...
            if (root.load && root.load.remembered) {
                var preset_map = root.load.remembered, preset;
                if (preset_map[gui.preset]) preset = preset_map[gui.preset]; else {
    ...
    function addSaveMenu(gui) {
        ...
        gui.load && gui.load.remembered ? common.each(gui.load.remembered, function(value, key) {
            addPresetOption(gui, key, key == gui.preset);
        }) : addPresetOption(gui, DEFAULT_DEFAULT_PRESET_NAME, !1);
        ...
        if (SUPPORTS_LOCAL_STORAGE) {
            var saveLocally = document.getElementById("dg-save-locally"), explain = document.getElementById("dg-local-explain");
            saveLocally.style.display = "block";
            var localStorageCheckBox = document.getElementById("dg-local-storage");
            localStorage.getItem(getLocalStorageHash(gui, "isLocal")) === "true" && localStorageCheckBox.setAttribute("checked", "checked");
        ...
        dom.bind(newConstructorTextArea, "keydown", function(e) {
            e.metaKey && (e.which === 67 || e.keyCode == 67) && SAVE_DIALOGUE.hide();
        });
    ...
    function setWidth(gui, w) {
        ...
        gui.__save_row && gui.autoPlace && (gui.__save_row.style.width = w + "px");
        gui.__closeButton && (gui.__closeButton.style.width = w + "px");
    }
    function getCurrentPreset(gui, useInitialValues) {
        var toReturn = {};
        common.each(gui.__rememberedObjects, function(val, index) {
            var saved_values = {}, controller_map = gui.__rememberedObjectIndecesToControllers[index];
    ...
    function addPresetOption(gui, name, setSelected) {
        ...
        setSelected && (gui.__preset_select.selectedIndex = gui.__preset_select.length - 1);
    }
    ...
    function updateDisplays(controllerArray) {
        controllerArray.length != 0 && requestAnimationFrame(function() {
    ...
    css.inject(styleSheet);
    var CSS_NAMESPACE = "dg", HIDE_KEY_CODE = 72, CLOSE_BUTTON_HEIGHT = 20, DEFAULT_DEFAULT_PRESET_NAME = "Default", SUPPORTS_LOCAL_STORAGE = function() {
        try {
            return "localStorage" in window && window.localStorage !== null;
        } catch (e) {
            return !1;
        }
    }(), SAVE_DIALOGUE, auto_place_virgin = !0, auto_place_container, hide = !1, hideable_guis = [], GUI = function(params) {
        ...
        } : params.preset && (params.load.preset = params.preset);
        common.isUndefined(params.parent) && params.hideable && hideable_guis.push(this);
        params.resizable = common.isUndefined(params.parent) && params.resizable;
        params.autoPlace && common.isUndefined(params.scrollable) && (params.scrollable = !0);
        ...
        Object.defineProperties(this, {
            ...
            preset: {
                ...
                set: function(v) {
                    _this.parent ? _this.getRoot().preset = v : params.load.preset = v;
            ...
            name: {
                ...
                set: function(v) {
                    params.name = v;
                    title_row_name && (title_row_name.innerHTML = params.name);
                }
            },
            closed: {
                get: function() {
                ...
                set: function(v) {
                    params.closed = v;
                    params.closed ? dom.addClass(_this.__ul, GUI.CLASS_CLOSED) : dom.removeClass(_this.__ul, GUI.CLASS_CLOSED);
                    this.onResize();
                    _this.__closeButton && (_this.__closeButton.innerHTML = v ? GUI.TEXT_OPEN : GUI.TEXT_CLOSED);
                }
            },
            load: {
                get: function() {
            ...
            useLocalStorage: {
                ...
                set: function(bool) {
                    if (SUPPORTS_LOCAL_STORAGE) {
                        ...
                        bool ? dom.bind(window, "unload", saveToLocalStorage) : dom.unbind(window, "unload", saveToLocalStorage);
        ...
        if (common.isUndefined(params.parent)) {
            ...
            if (SUPPORTS_LOCAL_STORAGE && use_local_storage) {
            ...
            params.closed === undefined && (params.closed = !0);
            var title_row_name = document.createTextNode(params.name);
            dom.addClass(title_row_name, "controller-name");
            var title_row = addRow(_this, title_row_name), on_click_title = function(e) {
                e.preventDefault();
                _this.closed = !_this.closed;
                return !1;
            };
        ...
        if (params.autoPlace) {
            ...
            this.parent || setWidth(_this, params.width);
        }
        ...
        this.onResize();
        params.resizable && addResizeHandle(this);
        var root = _this.getRoot();
    ...
    dom.bind(window, "keydown", function(e) {
        document.activeElement.type !== "text" && (e.which === HIDE_KEY_CODE || e.keyCode == HIDE_KEY_CODE) && GUI.toggleHide();
    }, !1);
    common.extend(GUI.prototype, {
        ...
        onResize: function() {
            ...
            if (root.scrollable) {
                var top = dom.getOffset(root.__ul).top, h = 0;
        ...
        remember: function() {
            ...
            common.each(Array.prototype.slice.call(arguments), function(object) {
                _this.__rememberedObjects.length == 0 && addSaveMenu(_this);
                _this.__rememberedObjects.indexOf(object) == -1 && _this.__rememberedObjects.push(object);
            });
        ...
        getSaveObject: function() {
            ...
            if (this.__rememberedObjects.length > 0) {
                ...
                toReturn.remembered || (toReturn.remembered = {});
        ...
        saveAs: function(presetName) {
            if (!this.load.remembered) {
                ...
                this.load.remembered[DEFAULT_DEFAULT_PRESET_NAME] = getCurrentPreset(this, !0);
            }
            this.load.remembered[presetName] = getCurrentPreset(this);
            this.preset = presetName;
            addPresetOption(this, presetName, !0);
        },
        revert: function(gui) {
        ...
        listen: function(controller) {
            ...
            init && updateDisplays(this.__listening);
        }
    });
    return GUI;
    ...
    return function(object, property) {
        ...
        if (common.isNumber(initialValue)) return common.isNumber(arguments[2]) && common.isNumber(arguments[3]) ? new NumberControllerSlider(object, property, arguments[2], arguments[3]) : new NumberControllerBox(object, property, {
            min: arguments[2],
            max: arguments[3]
        });
    ...
    common.extend(StringController.prototype, Controller.prototype, {
        updateDisplay: function() {
            dom.isActive(this.__input) || (this.__input.value = this.getValue());
    ...
    var ColorController = function(object, property) {
        ...
        function setSV(e) {
            e.preventDefault();
            var w = dom.getWidth(_this.__saturation_field), o = dom.getOffset(_this.__saturation_field), s = (e.clientX - o.left + document.body.scrollLeft) / w, v = 1 - (e.clientY - o.top + document.body.scrollTop) / w;
            v > 1 ? v = 1 : v < 0 && (v = 0);
            s > 1 ? s = 1 : s < 0 && (s = 0);
            _this.__color.v = v;
            _this.__color.s = s;
        ...
        function setH(e) {
            e.preventDefault();
            var s = dom.getHeight(_this.__hue_field), o = dom.getOffset(_this.__hue_field), h = 1 - (e.clientY - o.top + document.body.scrollTop) / s;
            h > 1 ? h = 1 : h < 0 && (h = 0);
    ...
    common.extend(ColorController.prototype, Controller.prototype, {
        updateDisplay: function() {
            ...
            if (i !== !1) {
                ...
                mismatch && common.extend(this.__color.__state, i);
            }
            common.extend(this.__temp.__state, this.__color.__state);
            this.__temp.a = 1;
            var flip = this.__color.v < .5 || this.__color.s > .5 ? 255 : 0, _flip = 255 - flip;
            common.extend(this.__field_knob.style, {
    ...
    function recalculateRGB(color, component, componentHexIndex) {
        if (color.__state.space === "HEX") color.__state[component] = math.component_from_hex(color.__state.hex, componentHexIndex); else {
            if (color.__state.space !== "HSV") throw "Corrupted color state";
    ...
    Object.defineProperty(Color.prototype, "hex", {
        get: function() {
            !this.__state.space !== "HEX" && (this.__state.hex = math.rgb_to_hex(this.r, this.g, this.b));
    ...
    return {
        hsv_to_rgb: function(h, s, v) {
            var hi = Math.floor(h / 60) % 6, f = h / 60 - Math.floor(h / 60), p = v * (1 - s), q = v * (1 - f * s), t = v * (1 - (1 - f) * s), c = [ [ v, t, p ], [ q, v, p ], [ p, v, t ], [ p, q, v ], [ t, p, v ], [ v, p, q ] ][hi];
            return {
                r: c[0] * 255,
                g: c[1] * 255,
                b: c[2] * 255
        ...
        rgb_to_hsv: function(r, g, b) {
            ...
            s = delta / max;
            r == max ? h = (g - b) / delta : g == max ? h = 2 + (b - r) / delta : h = 4 + (r - g) / delta;
            h /= 6;
            h < 0 && (h += 1);
            return {
                h: h * 360,
